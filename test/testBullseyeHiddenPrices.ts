...
import { BullseyeHiddenPrices } from "../typechain-types/contracts/BullseyeHiddenPrices";
import { BullseyeHiddenPrices__factory } from "../typechain-types/factories/contracts/BullseyeHiddenPrices__factory";
...
describe("BullseyeHiddenPrices", () => {
  ...
  beforeEach(async () => {
    ...
    Game = await new BullseyeHiddenPrices__factory(owner).deploy();
